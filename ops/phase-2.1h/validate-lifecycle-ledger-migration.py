...
# Append-only semantics: no update/delete trigger is introduced here; operational contract forbids them.
# This validator verifies inserts are independently durable and existing domain tables remain untouched.
