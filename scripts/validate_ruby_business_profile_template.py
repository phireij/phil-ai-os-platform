...
def main() -> None:
    ...
    publication_sections = tokushoho.split("# 2. Proposed production disclosure — Japanese", 1)[1].split("# 4. Reconciliation decisions and remaining launch checks", 1)[0]
    if "rubyscakedelights@gmail.com" in publication_sections:
        fail("legacy Gmail address must not remain in Japanese/English publication candidate")
