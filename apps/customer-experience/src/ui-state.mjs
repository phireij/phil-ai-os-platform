...
const messages = Object.freeze({
  en: Object.freeze({
    ...
    empty: Object.freeze({ title: "No products to show", message: "No products are available in this preview yet." }),
    error: Object.freeze({ title: "Preview unavailable", message: "We could not load the product preview. Please try again.", retry_label: "Reload preview" }),
  ...
  ja: Object.freeze({
    ...
    empty: Object.freeze({ title: "表示できる商品がありません", message: "このプレビューでは現在表示できる商品がありません。" }),
    error: Object.freeze({ title: "プレビューを利用できません", message: "商品プレビューを読み込めませんでした。もう一度お試しください。", retry_label: "プレビューを再読み込み" }),
